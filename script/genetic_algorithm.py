...
def optimize_normalized_genetic_algorithm_markowitz(population_size, num_assets, expected_returns, covariance_matrix,
    ...
    maximum_risk = normalization_parameters["std_min"] + (volatility_tolerance/100) * (normalization_parameters["std_max"] - normalization_parameters["std_min"])
